...
% mean_val=mean(T_data,2);
% T_data=T_data-mean_val;
%[BF_data,~]=l1pca(T_data,i)%,1,10,10,'');
%BF_data=l1pca_BF(T_data,i,1,10,10,'');
[BF_data,~,~]=svds(T_data,i);%l1pca_BF(T_data,i,1,100,100,'');
